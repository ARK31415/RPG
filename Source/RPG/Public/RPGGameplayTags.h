...
namespace RPGGameplayTags
{
	...
	//UI Layer Tags
	RPG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(RPGCommonUI_WidgetStack_Modal);
	RPG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(RPGCommonUI_WidgetStack_GameMenu);
	RPG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(RPGCommonUI_WidgetStack_GameHUD);
	RPG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(RPGCommonUI_WidgetStack_Frontend);
	RPG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(RPGCommonUI_WidgetStack_Loading);
}
