...
namespace RPGGameplayTags
{
	...
	//UI Layer Tags
	RPG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Layer_Game);
	RPG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Layer_GameMenu);
	RPG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Layer_Menu);
	RPG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Layer_Modal);
}
